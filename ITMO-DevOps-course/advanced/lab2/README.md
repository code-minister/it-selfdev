...
Вкатываться в DevOps я решил интенсивно, поэтому лабу делаю сразу после базовой. Проект я тоже взял оттуда: приложение для голосования, состоящее из 4 частей: backend, frontend, bd и worker.
